...
public class HoOnResponse extends HoOnMessage{
	...
	public static final String TYPE = "RESPONSE"; //represent the response type
	...
	public HoOnResponse(ErrorCode errorCode, long queryId, List<String> posts) throws IllegalArgumentException{
		if(errorCode == null || posts == null || !isLegalId(queryId) || !isLegalPostsNumber(posts.size())){
	...
	public int hashCode() {
		...
		result = prime * result + posts.hashCode();
